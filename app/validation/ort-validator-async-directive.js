System.register(['angular2/core', './ort-validator-async', 'angular2/common'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, ort_validator_async_1, common_1;
            ...
            OrtValidatorAsyncDirective = (function () {
                ...
                OrtValidatorAsyncDirective = __decorate([
                    core_1.Directive({
                        ...
                        providers: [new core_1.Provider(common_1.NG_ASYNC_VALIDATORS, { useValue: ort_validator_async_1.OrtValidatorAsync.validate, multi: true })]
                    }), 
